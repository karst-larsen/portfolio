  ...
  return (
    <>
          ...
          <div className="personal__image-text">
            ...
            <div className="personal__header">
              ...
              <span
                ...
                data-aos-once="true"
              >
                I'm a Full Stack Developer based out of Toronto, Ontario. Lover
                of JavaScript and interactive media.
              </span>{" "}
              <br />
            </div>
          </div>
        ...
        <div className="about__responsive-container">
          <div className="about__text-container">
            ...
            <p className="about__information">
              I have always had a passion for creative digital practices in many
              forms; editing YouTube videos, producing electronic music in
              digital audio workstations, and building courses as an eLearning
              ...
              challenges and improving my understanding of the language.
            </p>
            <p className="about__information">
              As an extension to my numerous years of editing experience, I
              began studying and self-teaching web-development. After a year of
              exploration of the field, I made the decision to complete{" "}
              <a
                href="https://brainstation.io/course/online/remote-web-development-bootcamp"
                className="about__link"
                target="blank"
              >
                BrainStation's Web Development Bootcamp
              </a>
              . This program allowed me to consolidate and expand my learning
              and get up to speed with industry standards. Now, as a graduate of
              the program, I can build websites and web applications from client
              to server.
            </p>
          </div>
          <div className="about__text-container">
            ...
            <p className="about__information">
              I'm currently working as a Teaching Assistant at BrainStation
              after being nominated as a suitable candidate to help future
              students through the program! It's been a great opportunity to
              revisit the material and get a deeper understanding of programming
              logic by answering student questions and reviewing code. Outside
              of my role as a Teaching Assistant, I am actively seeking
              developer roles in creative, experiential environments while
      ...
      <section className="skills" id="skills">
        ...
        <h2 className="skills__sub-header">
          A collection of software and languages that I've built websites,
          applications, and digital content with. I'm also eager to learn new
          frameworks and developer tools to expand my skillset! I'm currently
          expanding my knowledge of handling state and keeping up with the times
          by learning about{" "}
          <a
        ...
        <hr
          className="personal__horizontal-line personal__horizontal-line--skills-section"
          data-aos="fade-up"
          data-aos-once="true"
          data-aos-duration="1000"
        />
        <div
          className="skills__technologies"
          data-aos="fade-up"
          data-aos-easing="ease-in-out"
          data-aos-duration="1000"
          data-aos-delay="250"
      ...
      <section className="projects" id="projects">
        <div className="projects__responsive-container">
          ...
          <h3 className="skills__sub-header">
          ...
          <div className="projects__container">
            <div className="projects__bmo-icon-logo">
              <img
                src={quantipomoImage}
                className="projects__image projects__image--quantipomo"
                alt="BandSite Group"
              />
            </div>
            <div className="projects__bmo-description-links">
              <div className="projects__project-banner projects__project-banner--quantipomo">
                <img
                  ...
                  className="projects__quantipomo-logo"
                />
              </div>
              <p className="projects__information">
                My current work in progress: Quantipomo! A pomodoro timer
                application that gamifies deep focus.{" "}
                <p className="red-bolded">
                  Expected Release Date: December 5th
                </p>
              </p>
          ...
          <div className="projects__visualeyes-container">
            ...
            <div className="projects__visualeyes-description-links">
              ...
              />
              <p className="projects__information">
                An interactive music UI that pairs visual effects to user inputs
                on drum and synth sequencers.{" "}
                <p className="red-bolded">
                  Major overhaul coming November 21st!
                </p>
              </p>
              <div className="projects__links">
                <a
                ...
                <Link to="/visual-eyes" className="projects__link">
                  About
                </Link>
              </div>
            </div>
          ...
          <div className="projects__container">
            ...
            <div className="projects__bmo-description-links">
              ...
              <div className="projects__links">
                ...
                <Link to="/bmo-hackathon" className="projects__link">
                  About
                </Link>
              </div>
            </div>
