                ...
                <div className="capstone__container capstone__container--next">
                    <div className="capstone__wrapper">
                        ...
                        <ul className="capstone__improvements">
                            <li className="capstone__improvement" data-aos="fade-right" data-aos-duration="750" data-aos-easing="ease-in-out" data-aos-once="true">Sequence Swapping, Clearing, Randomization
                            ...
                            <li className="capstone__improvement" data-aos="fade-right" data-aos-duration="750" data-aos-easing="ease-in-out" data-aos-once="true">Sample Change, User Sample Upload
                                <ul ul className="capstone__improvements-item">
                            ...
                            <li className="capstone__improvement" data-aos="fade-right" data-aos-duration="750" data-aos-easing="ease-in-out" data-aos-once="true">User Save State, Account Creation
                        ...
                        <p className="capstone__vs-information" data-aos="fade-up" data-aos-duration="750" data-aos-easing="ease-in-out" data-aos-once="true">I think the biggest impact with this idea would be DAW integration with VisualEyes as a standalone plugin where the application interacts directly with MIDI inputs. That's currently beyond my scope, but as I continue to grow as a developer I hope to get closer to seeing that vision through to the end!</p>
                        <p className="capstone__vs-information" data-aos="fade-up" data-aos-duration="750" data-aos-easing="ease-in-out" data-aos-once="true">You can check out the <a href="https://visual-eyes-pi.vercel.app/" className="capstone__page-link" target="blank">live version of VisualEyes</a>, check out the <a href="https://github.com/karst-larsen/VisualEyes" className="capstone__page-link" target="blank">GitHub repo</a>, or <a href="mailto:karsten.oneill@hotmail.ca" className="capstone__page-link">send me a message</a> for ways that you think it can be improved.</p>
                    </div>
                </div>
        </div>
    );
